                ...
                <div class="lg:w-full lg:flex lg:justify-between">
                    ...
                    <div class="grow mb-6 lg:mb-0">
                        ...
                        <div class="flex flex-wrap lg:flex-col lg:flex-no-wrap">
                            ...
                            <a href="https://laravel.com" class="w-1/2 text-gray-400 mb-4 hover:text-gray-200 lg:mb-6">
                                <img loading="lazy" src="{{ asset('images/gitlab.png') }}" alt="Laravel" class="w-4 h-4 inline" />
                                Laravel
                            </a>
                        </div>
                    </div>
